...
public class pantsAdapter extends RecyclerView.Adapter<pantsAdapter.MyViewHolder> {
    ...
    public pantsAdapter(ArrayList<String> givenTitle, Context context){
    ...
    @Override
    public pantsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final pantsAdapter.MyViewHolder myViewHolder, final int i) {
            ...
            public void onCallback(final Bitmap value) {
                ...
                myViewHolder.textView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        editor.putString("pants", title.get(i));
                        editor.commit();
                    }
                });
            }
