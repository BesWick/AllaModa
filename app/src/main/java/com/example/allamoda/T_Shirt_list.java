...
public class T_Shirt_list extends Activity implements PictureCallback, SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(T_Shirt_list.this, Manifest.permission.CAMERA)
    ...
    protected void onResume() {
        ...
        if (mCamera == null) {
            try {
                ...
                int angleToRotate=getRoatationAngle(T_Shirt_list.this, Camera.CameraInfo.CAMERA_FACING_FRONT);
                ...
                Toast.makeText(T_Shirt_list.this, "Unable to open camera.", Toast.LENGTH_LONG)
                        .show();
            }
        }
    }
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        if (mCamera != null) {
            try {
                ...
                Toast.makeText(T_Shirt_list.this, "Unable to start camera preview.", Toast.LENGTH_LONG).show();
            }
        }
    }
