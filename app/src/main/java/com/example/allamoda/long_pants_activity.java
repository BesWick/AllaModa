...
public class long_pants_activity extends Activity implements PictureCallback, SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(long_pants_activity.this, Manifest.permission.CAMERA)
    ...
    protected void onResume() {
        ...
        if (mCamera == null) {
            try {
                ...
                int angleToRotate=getRoatationAngle(long_pants_activity.this, Camera.CameraInfo.CAMERA_FACING_FRONT);
                ...
                Toast.makeText(long_pants_activity.this, "Unable to open camera.", Toast.LENGTH_LONG)
                        .show();
            }
        }
    }
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        if (mCamera != null) {
            try {
                ...
                Toast.makeText(long_pants_activity.this, "Unable to start camera preview.", Toast.LENGTH_LONG).show();
            }
        }
    }
