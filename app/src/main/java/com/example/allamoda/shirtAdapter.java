...
public class shirtAdapter extends RecyclerView.Adapter<shirtAdapter.MyViewHolder> {
    ...
    public shirtAdapter (ArrayList<String> givenTitle, Context context){
    ...
    @Override
    public shirtAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final shirtAdapter.MyViewHolder myViewHolder, final int i) {
            ...
            public void onCallback(final Bitmap value) {
                ...
                myViewHolder.textView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        editor.putString("shirt", title.get(i));
                        editor.commit();

                        String out = sharedPref.getString("shirt","null");
                        Log.d(TAG, "onClick: shirt is "+ out);
