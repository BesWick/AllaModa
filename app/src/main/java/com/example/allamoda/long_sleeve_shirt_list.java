...
public class long_sleeve_shirt_list extends Activity implements Camera.PictureCallback, SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(long_sleeve_shirt_list.this, Manifest.permission.CAMERA)
                != PackageManager.PERMISSION_GRANTED) {
            // here, Permission is not granted
            ActivityCompat.requestPermissions(this, new String[] {android.Manifest.permission.CAMERA}, 50);
        }

        ImageView  image = (ImageView) findViewById(R.id.camera_preview);
    ...
    protected void onResume() {
        ...
        if (mCamera == null) {
            try {
                ...
                int angleToRotate=getRoatationAngle(long_sleeve_shirt_list.this, Camera.CameraInfo.CAMERA_FACING_FRONT);
                ...
                Toast.makeText(long_sleeve_shirt_list.this, "Unable to open camera.", Toast.LENGTH_LONG)
                        .show();
            }
        }
    }
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        if (mCamera != null) {
            try {
                ...
                Toast.makeText(long_sleeve_shirt_list.this, "Unable to start camera preview.", Toast.LENGTH_LONG).show();
            }
        }
    }
